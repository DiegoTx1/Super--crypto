 // =============================================
        ...
        function avaliarTendencia(ema5, ema13, ema50) {
          // Fatores de sensibilidade aumentados
          const diffCurta = ema5 - ema13;
          const diffLonga = ema13 - ema50;
          const forca = Math.min(100, (Math.abs(diffCurta) * 10000 + Math.abs(diffLonga) * 6000));
          
          // Limiares reduzidos para maior sensibilidade
          if (forca > 60) {
        ...
        function validarSinal(sinal, indicadores) {
          ...
          // Exigência reduzida (70% em vez de 80%)
          ...
          try {
            ...
            if (sinal !== "ESPERAR") {
              ...
              if (verificarTransicao()) {
                sinal = "ESPERAR";
                state.cooldown = 1; // Reduzido para 1 minuto
              }
        ...
        function atualizarInterface(sinal, score, tendencia, forcaTendencia) {
          ...
          if (ultimaAtualizacaoElement) {
            ultimaAtualizacaoElement.textContent = new Date().toLocaleTimeString();
          }
        }

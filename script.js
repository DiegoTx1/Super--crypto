...
<body>
    <div id="dashboard">
        <div id="header">
            <h1 id="titulo">TX1 LITE PRO v3.0</h1>
            <div id="status-container">
                <div class="status-item">
                    <span>Status:</span>
                    <span class="status-value online" id="status-conexao">CONECTADO</span>
                </div>
                <div class="status-item">
                    <span>Hora:</span>
                    <span class="status-value" id="hora">00:00:00</span>
                </div>
            </div>
        </div>

        <div class="card">
            <div id="comando-container">
        ...
        <div class="card">
            <div class="card-title">CRITÉRIOS TÉCNICOS</div>
            <ul id="criterios">
                <li><span>Carregando...</span><span></span></li>
            </ul>
        </div>
        ...
        <div class="card">
            <div id="status-container" style="justify-content: space-around;">
                <div class="status-item">
                    <div>Próxima leitura:</div>
    ...
    <audio id="som-call" src="https://assets.mixkit.co/sfx/preview/mixkit-winning-chimes-2015.mp3"></audio>
    <audio id="som-put" src="https://assets.mixkit.co/sfx/preview/mixkit-retro-arcade-lose-2027.mp3"></audio>
